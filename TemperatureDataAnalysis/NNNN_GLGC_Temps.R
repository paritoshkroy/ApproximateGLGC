...
save(elapsed_time, fit_summary, sampler_diag, fixed_summary, draws_df, z1_summary, pred_summary, scores_df, file = paste0(fpath,"TemperatureDataAnalysis/NNNN_GLGC_Temps.RData"))
