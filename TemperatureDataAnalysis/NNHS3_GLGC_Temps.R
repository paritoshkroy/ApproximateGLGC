...
save(elapsed_time, fit_summary, fixed_summary, draws_df, post_z1, z1_summary, file = paste0(fpath,"TemperatureDataAnalysis/NNHS3_GLGC_Temps.RData"))
...
save(nNeighbors, obsCoords, prdCoords, post_z1, yfitted_summary, fit_summary, m1, m2, mstar, elapsed_time, fixed_summary, draws_df, z1_summary, pred_summary, scores_df, file = paste0(fpath,"TemperatureDataAnalysis/NNHS3_GLGC_Temps.RData"))
...
save(nNeighbors, obsCoords, prdCoords, yfitted_summary, fit_summary, sampler_diag, m1, m2, mstar, elapsed_time, fixed_summary, draws_df, z_summary, kde_df, z1_summary, z2_summary, pred_summary, scores_df, file = paste0(fpath,"TemperatureDataAnalysis/NNHS3_GLGC_Temps.RData"))
