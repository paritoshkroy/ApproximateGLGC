...
save(elapsed_time, fixed_summary, draws_df, z1_summary, file = paste0(fpath,"LengthscaleSensitivity/Full_GLGC_LS",node,".RData"))
...
save(elapsed_time, fixed_summary, draws_df, z1_summary, pred_summary, scores_df, file = paste0(fpath,"LengthscaleSensitivity/Full_GLGC_LS",node,".RData"))
