...
save(elapsed_time, fixed_summary, draws_df, z1_summary, file = paste0(fpath,"SSTempDataAnalysis/NN15_NN15_GLGC_SST.RData"))
...
save(elapsed_time, sampler_diag, fixed_summary, draws_df, z1_summary, pred_summary, scores_df, file = paste0(fpath,"SSTempDataAnalysis/NN15_NN15_GLGC_SST.RData"))
