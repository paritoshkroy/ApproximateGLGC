...
save(elapsed_time, fixed_summary, draws_df, z1_summary, z2_summary, z_summary, pred_summary, scores_df, file = paste0(fpath,"ExactVsApproximateMethods/HSHS_GLGC.RData"))
