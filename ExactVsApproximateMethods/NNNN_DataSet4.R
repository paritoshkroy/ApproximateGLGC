...
save(elapsed_time, fixed_summary, draws_df, z1_summary, post_z1, pred_summary, scores_df, file = paste0(fpath,"ExactVsApproximateMethods/NNNN_DataSet4.RData"))
...
ggplot(z_summary) +
  ...
  theme(panel.grid = element_blank(),
        ...
        legend.title = element_blank())
ggsave(paste0(fpath,"ExactVsApproximateMethods/NNNN_DataSet4_SpatialEffect_Density.png"), height = 4, width = 6)

save(elapsed_time, z_summary, kde_df, yfitted_summary, fit_summary, fixed_summary, draws_df, pred_summary, scores_df, file = paste0(fpath,"ExactVsApproximateMethods/NNNN_DataSet4.RData"))
