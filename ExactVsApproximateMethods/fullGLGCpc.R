...
input <- list(N = nsize, P = P, y = obsY, X = obsX, coords = obsCoords, mu_beta = mu_beta, V_beta = V_beta, lambda_sigma1 = lambda_sigma1, lambda_sigma2 = lambda_sigma2, lambda_tau = lambda_tau, lambda_ell1 = lambda_ell1, lambda_ell2 = lambda_ell2)
str(input)

library(cmdstanr)
stan_file <- paste0(fpath,"StanFiles/fullGLGCpc.stan")
...
save(elapsed_time, fixed_summary, draws_df, z_summary, file = paste0(fpath,"ExactVsApproximateMethods/fullGLGCpc.RData"))
...
save(elapsed_time, fixed_summary, draws_df, z_summary, pred_summary, scores_df, file = paste0(fpath,"ExactVsApproximateMethods/fullGLGCpc.RData"))
