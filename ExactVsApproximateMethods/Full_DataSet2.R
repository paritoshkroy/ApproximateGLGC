...
save(elapsed_time, fixed_summary, draws_df, z1_summary, post_z1, yfitted_summary, pred_summary, scores_df, file = paste0(fpath,"ExactVsApproximateMethods/Full_DataSet2.RData"))
...
ggplot(z_summary) +
  ...
  theme(panel.grid = element_blank(),
        legend.position = c(0.2,0.8),
        legend.title = element_blank())
ggsave(paste0(fpath,"ExactVsApproximateMethods/Full_DataSet2_SpatialEffect_Density.png"), height = 4, width = 6)

save(elapsed_time, scores_df, z_summary, yfitted_summary, kde_df, fixed_summary, draws_df, file = paste0(fpath,"ExactVsApproximateMethods/Full_DataSet2.RData"))
