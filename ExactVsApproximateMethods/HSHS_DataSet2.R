...
save(sampler_diag, elapsed_time, fixed_summary, draws_df, z1_summary, z2_summary, z_summary, post_z, pred_summary, yfitted_summary, scores_df, file = paste0(fpath,"ExactVsApproximateMethods/HSHS_DataSet2.RData"))
...
ggsave(paste0(fpath,"ExactVsApproximateMethods/HSHS_DataSet2_SpatialEffect_Density.png"), height = 4, width = 6)

save(sampler_diag, kde_df, elapsed_time, fixed_summary, draws_df, z1_summary, z2_summary, z_summary, post_z, yfitted_summary, pred_summary, scores_df, file = paste0(fpath,"ExactVsApproximateMethods/HSHS_DataSet2.RData"))
